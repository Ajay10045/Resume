...
\begin{tabular}{p{0.48\textwidth} p{0.48\textwidth}}
    ...
    \textbf{ML Techniques:} Regression, Classification & \textbf{Data Visualization:} Tableau, R Shiny, Power BI \\
    \textbf{ML Libraries:} Scikit-learn, PyTorch, & \textbf{MLOps:} Kedro, Git, Docker \\
\end{tabular}
