...
\definecolor{headerbg}{RGB}{53,120,229} % Blue color for the header background
\definecolor{headerfg}{RGB}{255,255,255} % White color for the header text

% Define custom commands for rating system
\newcommand{\rating}[1]{\hfill\makebox[0pt][l]{#1\,/\,5}}
\newcommand{\ratinglabel}[1]{\textcolor{blue}{\scriptsize #1}}
...
\begin{center}
    ...
    \begin{tabular}{@{}c@{}}
        \includegraphics[height=3cm,width=3cm,keepaspectratio]{my_photo} \\
